  ...
  <body onload="urlToOutput();">
    ...
    <section class="ftco-section ftco-no-pt bg-light front-page-text">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <input type="text" id="input-field" class="form-control" placeholder="Περιοχή">
            <input type="button" class="btn btn-primary" value="Submit" onclick="inputToUrl('area', document.getElementById('input-field').value);">
          </div>
        </div>
      </div>
    </section>

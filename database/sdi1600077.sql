...
-- Schema sdi1600077
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `sdi1600077` ;

-- -----------------------------------------------------
-- Schema sdi1600077
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sdi1600077` DEFAULT CHARACTER SET utf8 ;
USE `sdi1600077` ;

-- -----------------------------------------------------
-- Table `sdi1600077`.`user_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`user_category` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`user_category` (
...
-- -----------------------------------------------------
-- Table `sdi1600077`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`user` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`user` (
  ...
  CONSTRAINT `fk_user_user_category1`
    ...
    REFERENCES `sdi1600077`.`user_category` (`iduser_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sdi1600077`.`ticket_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`ticket_category` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`ticket_category` (
...
-- -----------------------------------------------------
-- Table `sdi1600077`.`ticket`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`ticket` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`ticket` (
  ...
  CONSTRAINT `fk_ticket_user1`
    FOREIGN KEY (`iduser`)
    REFERENCES `sdi1600077`.`user` (`iduser`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ticket_ticket_category1`
    FOREIGN KEY (`idticket_category`)
    REFERENCES `sdi1600077`.`ticket_category` (`idticket_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sdi1600077`.`transport`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`transport` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`transport` (
...
-- -----------------------------------------------------
-- Table `sdi1600077`.`line_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`line_status` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`line_status` (
...
-- -----------------------------------------------------
-- Table `sdi1600077`.`colour`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`colour` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`colour` (
...
-- -----------------------------------------------------
-- Table `sdi1600077`.`line`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`line` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`line` (
  ...
  CONSTRAINT `fk_line_transport1`
    ...
    REFERENCES `sdi1600077`.`transport` (`idtransport`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_line_line_status1`
    FOREIGN KEY (`idline_status`)
    REFERENCES `sdi1600077`.`line_status` (`idline_status`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_line_colour1`
    FOREIGN KEY (`idcolour`)
    REFERENCES `sdi1600077`.`colour` (`idcolour`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sdi1600077`.`area`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`area` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`area` (
...
-- -----------------------------------------------------
-- Table `sdi1600077`.`station`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`station` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`station` (
  ...
  CONSTRAINT `fk_station_area1`
    FOREIGN KEY (`idarea`)
    REFERENCES `sdi1600077`.`area` (`idarea`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sdi1600077`.`line_has_station`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`line_has_station` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`line_has_station` (
  `idline` INT NOT NULL,
  ...
  CONSTRAINT `fk_line_has_station_line1`
    FOREIGN KEY (`idline`)
    REFERENCES `sdi1600077`.`line` (`idline`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_line_has_station_station1`
    FOREIGN KEY (`idstation`)
    REFERENCES `sdi1600077`.`station` (`idstation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sdi1600077`.`card`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1600077`.`card` ;

CREATE TABLE IF NOT EXISTS `sdi1600077`.`card` (

...
CREATE TABLE IF NOT EXISTS `oasa`.`station` (
  ...
  INDEX `fk_station_area1_idx` (`idarea` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `oasa`.`card` (
  ...
  `expired` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`idcard`),
  INDEX `fk_card_ticket_category1_idx` (`idticket_category` ASC) VISIBLE,
  INDEX `fk_card_user1_idx` (`iduser` ASC) VISIBLE,
